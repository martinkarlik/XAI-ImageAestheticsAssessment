...
WEDDINGS_DATAFRAME_PATH = ""

GIIAA_MODEL = "models/giiaa-hist_200k_base-inceptionresnetv2_loss-0.078.hdf5"

LOG_PATH = "datasets/weddings/metadata/training_logs"
MODELS_PATH = "models/"
MODEL_NAME_TAG = "weddings"
...
if __name__ == "__main__":
    ...
    dataframe = pd.read_csv(WEDDINGS_DATAFRAME_PATH, converters={'label': eval})
