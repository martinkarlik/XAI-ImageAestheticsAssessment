...
import src.musiq.multiscale_transformer_utils as utils
import src.musiq.resnet as resnet
...
#   def apply(self, params, image1, image2):
#     image_encoding1 = self.image_encoder.call(params, image1)
#     image_encoding2 = self.image_encoder.call(params, image2)

#     comparison_result = jnp.where(image_encoding1 > image_encoding2, 0, 1)
